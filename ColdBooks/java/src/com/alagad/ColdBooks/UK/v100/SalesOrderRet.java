 ...
 *         &lt;element ref="{}IsFullyInvoiced" minOccurs="0"/>
 ...
 *           &lt;element ref="{}SalesOrderLineRet"/>
 *           &lt;element ref="{}SalesOrderLineGroupRet"/>
 *         &lt;/choice>
...
@XmlType(name = "", propOrder = {
    ...
    "externalGUID",
    "linkedTxn",
    "salesOrderLineRetOrSalesOrderLineGroupRet",
    "dataExtRet"
})
@XmlRootElement(name = "SalesOrderRet")
public class SalesOrderRet {
    ...
    @XmlElements({
        @XmlElement(name = "SalesOrderLineGroupRet", type = SalesOrderLineGroupRet.class),
        @XmlElement(name = "SalesOrderLineRet", type = SalesOrderLineRet.class)
    })
    protected List<Object> salesOrderLineRetOrSalesOrderLineGroupRet;
    ...
    /**
     * Gets the value of the salesOrderLineRetOrSalesOrderLineGroupRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the salesOrderLineRetOrSalesOrderLineGroupRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSalesOrderLineRetOrSalesOrderLineGroupRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SalesOrderLineGroupRet }
     * {@link SalesOrderLineRet }
     * 
     * 
     */
    public List<Object> getSalesOrderLineRetOrSalesOrderLineGroupRet() {
        if (salesOrderLineRetOrSalesOrderLineGroupRet == null) {
            salesOrderLineRetOrSalesOrderLineGroupRet = new ArrayList<Object>();
        }
        return this.salesOrderLineRetOrSalesOrderLineGroupRet;
    }
