...
/**
 * <p>Java class for BillToPayQueryRsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BillToPayQueryRsType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{}BillToPayRet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "BillToPayQueryRsType", propOrder = {
    "billToPayRet"
})
public class BillToPayQueryRsType {

    @XmlElement(name = "BillToPayRet")
    protected List<BillToPayRet> billToPayRet;
    @XmlAttribute
    ...
    /**
     * Gets the value of the billToPayRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the billToPayRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBillToPayRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BillToPayRet> getBillToPayRet() {
        if (billToPayRet == null) {
            billToPayRet = new ArrayList<BillToPayRet>();
        }
        return this.billToPayRet;
    }
