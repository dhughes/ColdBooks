 ...
 *         &lt;element ref="{}CreditMemoLineRet" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "CreditMemoLineGroupRet")
public class CreditMemoLineGroupRet {
    ...
    @XmlElement(name = "CreditMemoLineRet", required = true)
    protected List<CreditMemoLineRet> creditMemoLineRet;
    ...
    /**
     * Gets the value of the creditMemoLineRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the creditMemoLineRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCreditMemoLineRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CreditMemoLineRet> getCreditMemoLineRet() {
        if (creditMemoLineRet == null) {
            creditMemoLineRet = new ArrayList<CreditMemoLineRet>();
        }
        return this.creditMemoLineRet;
    }
