 ...
 *         &lt;element ref="{}EstimateLineRet" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "EstimateLineGroupRet")
public class EstimateLineGroupRet {
    ...
    @XmlElement(name = "EstimateLineRet", required = true)
    protected List<EstimateLineRet> estimateLineRet;
    ...
    /**
     * Gets the value of the estimateLineRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the estimateLineRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEstimateLineRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EstimateLineRet> getEstimateLineRet() {
        if (estimateLineRet == null) {
            estimateLineRet = new ArrayList<EstimateLineRet>();
        }
        return this.estimateLineRet;
    }
