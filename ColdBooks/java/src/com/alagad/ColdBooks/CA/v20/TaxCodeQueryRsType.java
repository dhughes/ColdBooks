...
/**
 * <p>Java class for TaxCodeQueryRsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TaxCodeQueryRsType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{}TaxCodeRet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "TaxCodeQueryRsType", propOrder = {
    "taxCodeRet"
})
public class TaxCodeQueryRsType {

    @XmlElement(name = "TaxCodeRet")
    protected List<TaxCodeRet> taxCodeRet;
    @XmlAttribute
    ...
    /**
     * Gets the value of the taxCodeRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the taxCodeRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTaxCodeRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TaxCodeRet> getTaxCodeRet() {
        if (taxCodeRet == null) {
            taxCodeRet = new ArrayList<TaxCodeRet>();
        }
        return this.taxCodeRet;
    }
