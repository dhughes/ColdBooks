...
/**
 * <p>Java class for TxnDeletedQueryRsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TxnDeletedQueryRsType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{}TxnDeletedRet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "TxnDeletedQueryRsType", propOrder = {
    "txnDeletedRet"
})
public class TxnDeletedQueryRsType {

    @XmlElement(name = "TxnDeletedRet")
    protected List<TxnDeletedRet> txnDeletedRet;
    @XmlAttribute
    ...
    /**
     * Gets the value of the txnDeletedRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the txnDeletedRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTxnDeletedRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TxnDeletedRet> getTxnDeletedRet() {
        if (txnDeletedRet == null) {
            txnDeletedRet = new ArrayList<TxnDeletedRet>();
        }
        return this.txnDeletedRet;
    }
