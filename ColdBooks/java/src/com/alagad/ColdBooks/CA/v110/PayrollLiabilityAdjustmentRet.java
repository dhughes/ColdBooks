 ...
 *         &lt;element ref="{}PayrollLiabilityAdjustmentLineRet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "PayrollLiabilityAdjustmentRet")
public class PayrollLiabilityAdjustmentRet {
    ...
    @XmlElement(name = "PayrollLiabilityAdjustmentLineRet")
    protected List<PayrollLiabilityAdjustmentLineRet> payrollLiabilityAdjustmentLineRet;
    ...
    /**
     * Gets the value of the payrollLiabilityAdjustmentLineRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the payrollLiabilityAdjustmentLineRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPayrollLiabilityAdjustmentLineRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PayrollLiabilityAdjustmentLineRet }
     * 
     * 
     */
    public List<PayrollLiabilityAdjustmentLineRet> getPayrollLiabilityAdjustmentLineRet() {
        if (payrollLiabilityAdjustmentLineRet == null) {
            payrollLiabilityAdjustmentLineRet = new ArrayList<PayrollLiabilityAdjustmentLineRet>();
        }
        return this.payrollLiabilityAdjustmentLineRet;
    }
