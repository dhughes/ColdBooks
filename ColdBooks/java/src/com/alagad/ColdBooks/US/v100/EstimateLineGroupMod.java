 ...
 *         &lt;element ref="{}EstimateLineMod" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "EstimateLineGroupMod")
public class EstimateLineGroupMod {
    ...
    @XmlElement(name = "EstimateLineMod")
    protected List<EstimateLineMod> estimateLineMod;
    ...
    /**
     * Gets the value of the estimateLineMod property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the estimateLineMod property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEstimateLineMod().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EstimateLineMod> getEstimateLineMod() {
        if (estimateLineMod == null) {
            estimateLineMod = new ArrayList<EstimateLineMod>();
        }
        return this.estimateLineMod;
    }
