 ...
 *         &lt;element ref="{}ItemLineMod" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ItemGroupLineMod")
public class ItemGroupLineMod {
    ...
    @XmlElement(name = "ItemLineMod")
    protected List<ItemLineMod> itemLineMod;
    ...
    /**
     * Gets the value of the itemLineMod property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the itemLineMod property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getItemLineMod().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ItemLineMod> getItemLineMod() {
        if (itemLineMod == null) {
            itemLineMod = new ArrayList<ItemLineMod>();
        }
        return this.itemLineMod;
    }
