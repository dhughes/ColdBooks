...
/**
 * <p>Java class for ShipMethodQueryRsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ShipMethodQueryRsType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{}ShipMethodRet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ShipMethodQueryRsType", propOrder = {
    "shipMethodRet"
})
public class ShipMethodQueryRsType {

    @XmlElement(name = "ShipMethodRet")
    protected List<ShipMethodRet> shipMethodRet;
    @XmlAttribute
    ...
    /**
     * Gets the value of the shipMethodRet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the shipMethodRet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getShipMethodRet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ShipMethodRet> getShipMethodRet() {
        if (shipMethodRet == null) {
            shipMethodRet = new ArrayList<ShipMethodRet>();
        }
        return this.shipMethodRet;
    }
