...
@XmlRootElement(name = "DataEventSubscriptionRet")
public class DataEventSubscriptionRet {
    ...
    @XmlElement(name = "TrackLostEvents", required = true, defaultValue = "None")
