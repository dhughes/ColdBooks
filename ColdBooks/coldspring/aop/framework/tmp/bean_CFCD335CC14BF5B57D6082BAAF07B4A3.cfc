...
<cfcomponent name="coldspring.aop.framework.tmp.bean_CFCD335CC14BF5B57D6082BAAF07B4A3" 
			displayname="AopProxyBean" 
			extends="model.service.qbwc"
			hint="Abstract Base Class for Aop Proxy Beans" 
			output="false">
			
	<cffunction name="init" access="public" returntype="model.service.qbwc" output="false">
