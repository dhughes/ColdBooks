...
<cfcomponent name="coldspring.aop.framework.tmp.bean_10C46763D405DCDC6941C158FA53B361" 
			displayname="AopProxyBean" 
			extends="ColdBooks.model.service.qbwc"
			hint="Abstract Base Class for Aop Proxy Beans" 
			output="false">
			
	<cffunction name="init" access="public" returntype="ColdBooks.model.service.qbwc" output="false">
